    ...
    <main>
      ...
      <section className="analitics">
        <div className="container analiticsContent">
          <img src="/analysis.png" alt="Analitics" className="analiticsImage" />
      ...
      <section className="work">
        <div className="container workContent">
          ...
          <p className="workDescription">Growth your business with using us</p>
      ...
      <section className="comments">
        <div className="container">
          ...
          />
          <img src="/Vector.svg" alt="Shape" className="position alarmShape" />
        </div>
      </section>
